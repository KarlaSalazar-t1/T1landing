...
/* Halo con logos de paquetería orbitando + mini-card de cotización al centro
...
export default function T1EnviosOrbitHalo({ size = 420, radius = 192 }: { size?: number; radius?: number }) {
  ...
  return (
    <div className="relative mx-auto" style={{ width: size, height: size }}>
      ...
      {/* Núcleo — mini-card de cotización (mismo estilo que Ahorra / Cotiza) */}
        ...
        <div className="rounded-[16px] bg-white p-3.5" style={{ boxShadow: "0 20px 50px rgba(0,0,0,0.35)", fontFamily: "var(--font-manrope-var), 'Manrope', sans-serif" }}>
          <div className="flex items-center gap-2.5">
            <span className="flex h-[32px] w-[32px] shrink-0 items-center justify-center overflow-hidden rounded-full">
              <Image src="/img/circles/fedex.svg" alt="" width={40} height={40} className="h-full w-full object-cover" />
            </span>
            <div className="min-w-0 leading-tight">
              <p className="text-[13px] font-bold text-black">FedEx</p>
              <p className="text-[11px] text-black/50">CDMX → Guadalajara</p>
            </div>
          </div>
          <div className="mt-3 flex items-end justify-between">
            <div className="leading-tight">
              <p className="text-[10px] text-black/45">Entrega</p>
              <p className="text-[12.5px] font-bold text-black">2 días hábiles</p>
            </div>
            <div className="text-right leading-tight">
              <p className="text-[10px] text-black/45">Precio</p>
              <p className="text-[15px] font-bold text-black">$115<span className="ml-0.5 text-[9px] font-semibold text-black/45">MXN</span></p>
            </div>
          </div>
