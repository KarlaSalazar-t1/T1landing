...
const TAB_CARDS: TabCard[] = [
  {
    ...
    ctaHref: "/registro",
    subTabs: [
      { label: "Tienda con IA", description: "Describe tu negocio y nuestra IA creará tu tienda en segundos, lista para vender.", image: null, floatingCards: null, panel: "tienda-ia" },
