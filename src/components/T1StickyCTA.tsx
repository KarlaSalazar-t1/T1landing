...
/* CTA sticky solo-móvil, reutilizable (Pagos, Envíos, etc.).
...
export default function T1StickyCTA({ label, href, section = "sticky_mobile" }: { label: string; href: string; section?: string }) {
  ...
  return (
    <div
      ...
      style={{ transform: show ? "translateY(0)" : "translateY(130%)", transition: "transform 0.32s cubic-bezier(0.22,1,0.36,1)" }}
    >
