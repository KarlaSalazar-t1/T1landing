...
/* Mosaico asimétrico de tiendas reales (desktop + móvil) con parallax al hacer
   scroll y una card de texto que flota al centro. Versión "bento grid" (más alta
   que el carrusel). Las imágenes son mocks; se repiten a propósito para llenar. */
...
export default function T1TiendaMosaico() {
