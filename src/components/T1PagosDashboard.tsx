...
export default function T1PagosDashboard() {
  ...
  return (
    <div className="relative mx-auto w-full select-none" aria-hidden style={{ maxWidth: 420, fontFamily: FONT, pointerEvents: "none" }}>
      {/* Chip Ganancias Brutas */}
      <div className="absolute -right-2 -top-5 z-20 hidden rounded-[16px] border border-black/[0.06] bg-white px-4 py-3 tablet:block" style={{ boxShadow: "0 18px 44px rgba(0,0,0,0.22)" }}>
