              ...
              <div className="absolute inset-0 z-0">
                {pageMode ? (
                  /* AI-style backdrop: pure black with soft color blobs + a faint
                     ...
                     frase" section below). */
                  <>
                    {/* Base compartida de los heroes (mismo fondo cálido que envíos/pagos/tienda) */}
            ...
            {pageMode && (
              <>
                ...
                <T1FinalCTA
                  ...
                  description="Empieza gratis, sin tarjeta. Cuéntale a la IA qué vendes y deja que arme tu tienda en segundos."
