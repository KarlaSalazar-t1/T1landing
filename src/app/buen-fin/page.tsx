/* Variante Buen Fin de la home — misma home nueva, con el hero adaptado
   (badge + copy Buen Fin y el logo MIPYMES × Buen Fin). */
...
export default function BuenFinLanding() {
  return (
    <main className="min-h-screen">
      <T1Navbar bVariant />

      {/* Hero (versión B) — variante Buen Fin */}
      <T1HeroB buenFin />
